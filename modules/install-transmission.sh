...
tr -d '\r' < /bandito-box/apps/Bandito-Box/conf/etc/nginx/conf.d/services/service-transmission.conf > /bandito-box/.conf/Nginx/services/service-transmission.conf
